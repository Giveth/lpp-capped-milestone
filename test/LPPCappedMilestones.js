...
const LPPCappedMilestones = require('../lib/LPPCappedMilestones');
const { LPPCappedMilestonesRuntimeByteCode } = require('../build/LPPCappedMilestones.sol');
...
describe('LPPCappedMilestones test', function() {
    ...
    it('Should deploy LiquidPledging contract', async() => {
        ...
        liquidPledging = await LiquidPledgingMock.new(web3, vault.$address, accounts[0], accounts[1], { $gas: 5800000 });
        // liquidPledging = await LiquidPledging.new(web3, vault.$address, accounts[0], accounts[1]);

        console.log('liquidPledging', liquidPledging)
